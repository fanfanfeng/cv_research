...
if __name__ == '__main__':
  ...
  default_dict = {}
  default_dict['architecture'] = 'mobilenet_1.0_224'
  if 'win' in sys.platform:
    default_dict['model_dir'] = r'E:\cv_data\model\mobilenet_v1_1.0_224\mobilenet_v1_1.0_224'
    default_dict['image_dir'] = r'E:\cv_data\treatImg\500X500'
  else:
    default_dict['model_dir'] = r'/data/cv_model/mobilenet_v1_1.0_224/mobilenet_v1_1.0_224'
    default_dict['image_dir'] = r'/data/cv_model/treatImg/500X500'
  default_dict['bottleneck_dir'] = r'tmp/bottleneck-my'
  parser = argparse.ArgumentParser()
  parser.add_argument(
      '--image_dir',
      type=str,
      default=default_dict['image_dir'],
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default=default_dict['model_dir'],
      help="""\
  ...
  parser.add_argument(
      '--architecture',
      type=str,
      default=default_dict['architecture'],
      help="""\
...
# sample cmd:
# D:\ProgramData\Anaconda3\python.exe E:/github/cv_research/classification/retrain.py --architecture mobilenet_1.0_224_quant --model_dir E:\cv_data\model\mobilenet_v1_1.0_224_quant --image_dir E:\cv_data\captureImg_resize\300X300 --flip_left_right True --random_crop 1 --random_brightness 1